...
int main(int argc, char *argv[]) {
    ...
    /*si avviano i 6 processi obbligatori p: Ad ogni p viene passato la modalità di esecuzione, Pnumber che specifica quale processo p deve 
    ...
    //si crea il processo Decision Function -> in questo caso la ECU 
    if (pid_decision == 0) {
